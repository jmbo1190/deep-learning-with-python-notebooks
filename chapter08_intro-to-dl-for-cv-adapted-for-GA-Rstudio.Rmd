...
def model_layers_summary(model, prefix=""):
    ...
    for i, layer in enumerate(model.layers):
        print(prefix+str(i), layer.name, '('+layer.__class__.__module__+"."+layer.__class__.__qualname__+')', 'shape:', get_output_shape(layer), 'trainable:', layer.trainable, 'params:', layer.count_params())
        if hasattr(layer, 'layers'):
            model_layers(layer, prefix=prefix+"   +-> "+str(i)+".")
```
