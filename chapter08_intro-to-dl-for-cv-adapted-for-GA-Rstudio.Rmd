...
for i, layer in enumerate(model.layers):
    print(i, layer.name, layer.__class__.__name__, get_output_shape(layer), layer.trainable, layer.count_params())
    if layer.name == "vgg16":
        for l in layer:
            print(l.name, l.__class__.__name__, get_output_shape(l), l.trainable, l.count_params())
```
